...
COORDINATES_FILE = "/home/alancruz/RutaFacil-api/python/rutaTecIda.json"  # Archivo JSON con las coordenadas
...
if __name__ == "__main__":
    ...
    if coordinates:
        ...
        try:
            ws.on_open = lambda ws: simulate_bidirectional_route(ws, vehicle_id=3, coordinates=coordinates, interval=0.5)
            ws.run_forever()
